 ...
 */
public class RetornaElementos extends HttpServlet {
...
//        System.out.println("\n\n\n\n");
//        for (ElementosStorytelling elementosStorytelling : lista) {
//            System.out.println("\nTEste:  " + elementosStorytelling.getCaminho() + " -- "
//                    + elementosStorytelling.getInformacaoTexto() + " -- " + elementosStorytelling.getCodigo());
//        }
