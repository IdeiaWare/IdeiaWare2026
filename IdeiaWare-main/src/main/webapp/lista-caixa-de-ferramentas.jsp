            ...
            <c:forEach var="caixa" items="${ideiasCaixa}" varStatus="id">
                ...
                <li>
                  <div class="collapsible-header">
                    <span style="width: 20%; text-align: left;" class="truncate"    ><c:out value="${caixa.ideia.usuario.nome}"/></span>
                    <span style="width: 25%; text-align: left;" class="truncate"    ><c:out value="${caixa.ideia.titulo}"/></span>
                    <span style="width: 50%; text-align: left;" class="truncate"    ><c:out value="${caixa.ideia.descricao}"/></span>
