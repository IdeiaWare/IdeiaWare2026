					...
					<div class="row">
						<div class="col s12 m8 offset-m2">
							...
							<div class="card-panel indigo lighten-1" style="margin-top: 40px;">
								...
								<%-- UX-SUCESSO-PROXIMA-ETAPA: informa o proximo modulo (ExportaStoryServlet seta status CAIXA_FERRAMENTAS). --%>
								<div class="white-text center-align" style="padding-top:4px;">Sua ideia avan&ccedil;ou para a etapa da Caixa de Ferramentas.</div>
