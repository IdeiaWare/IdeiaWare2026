        ...
        <div style="padding: 10px; border-radius: 0.2em" class="white">
                ...
                <li>
                  ...
                  <div class="collapsible-body">
                    <div id="parteCima" style="text-align: justify;">
                      <b>Usuário: </b> <c:out value="${canva.ideia.usuario.nome}"/>
                      <br>
                      <b>Título: </b> <c:out value="${canva.ideia.titulo}"/>
                      <br>
                      <b>Descrição: </b><br><c:out value="${iLog.descricao}"/>
                      <br>
                      <b>Data de criação: </b>${data.formatarData(canva.ideia.dtCriacao)}<br>
                    </div>
          ...
          <c:if test="${empty ideiasCanva}">
            <div class="center-align grey-text" style="padding: 40px 20px;">
              ...
              Você ainda não tem ideias no Canvas.
            </div>
          </c:if>
        </div>
      </div>
...
//                        aqui é onde tudo é inserido na div, dá pra criar divs depois do igual
  ...
  <footer class="center blue darken-4 page-footer">
    <div class="container">
      <div class="row">
