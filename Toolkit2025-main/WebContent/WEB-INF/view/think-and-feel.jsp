...
<t:header></t:header>
	...
	<a href="${pageContext.request.contextPath}/persona/empatia/mapa?personaId=${personaId}" class="btn-floating btn-large red darken-3 tooltipped" style="position:fixed; top:75px; left:20px; z-index:998;" data-position="right" data-delay="50" data-tooltip="Voltar"><i class="material-icons">arrow_back</i></a>
	<nav class="crumb">
	    <div class="nav-wrapper">
	        ...
	        <span class="breadcrumb active">O que ela Pensa e Sente</span>
	    </div>
  	</nav>
	<div class="row">
		<div class="col s12 l6 vertical-divider">
			<h4>O que ela realmente Pensa e Sente?</h4>
			<h5>Tente descrever o que acontece na mente da cliente</h5>
			<ul class="browser-default">
				<li>O que é realmente importante para ela (que talvez não diria publicamente)?</li>
				<li>Imagine suas emoções. O que a motiva?</li>
				<li>O que pode mantê-la acordada à noite?</li>
				<li>Tente descrever os seus sonhos e desejos.</li>
			</ul>
		</div>
		<div class="col s12 l6 attribute">
			<form:form action="o-que-pensa-e-sente/save-attribute" modelAttribute="attribute" method="POST" class="col s12">
				<div class="row">					
					<form:hidden class="attribute-id" path="id"/>
					<form:hidden path="personaId" value="${personaId}"/>
					<form:hidden path="attribute" value="think_feel"/>
						
					<div class="input-field col s12">
			          <form:textarea id="attribute-text" class="materialize-textarea" path="attributeText" />
			          <label for="attribute-text">O que ela Pensa e Sente?</label>
			        ...
			        <div class="input-field col s4">
			        	<input type="submit" value="Adicionar" class="waves-effect waves-light btn add-attribute"/>
			        </div>
		...
		<div class="col s12 attributes-list">
			<div class="row">
				...
				<c:forEach var="tempAttribute" items="${attributes}">
					<%-- TK-26: excluir atributo virou form POST --%>
					<form id="deleteAttributeForm${tempAttribute.id}" action="${pageContext.request.contextPath}/persona/empatia/o-que-pensa-e-sente/delete" method="POST" style="display:none;">
			        ...
			        <div class="col s12 m4 item">
		          		<div class="card <c:out value='${tempAttribute.cardColor}'/>">
		            		...
		            		<div class="card-action">
			              		...
			              		<a href="javascript:;"
									onclick="if (confirm('Excluir este atributo? Esta ação não pode ser desfeita.')) document.getElementById('deleteAttributeForm${tempAttribute.id}').submit();">
