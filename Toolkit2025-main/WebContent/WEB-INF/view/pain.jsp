		...
		<div class="col s12 attributes-list">
			<div class="row">
				...
				<c:forEach var="tempAttribute" items="${attributes}">
					...
					<form id="deleteAttributeForm${tempAttribute.id}" action="${pageContext.request.contextPath}/persona/empatia/quais-sao-as-dores/delete" method="POST" style="display:none;">
