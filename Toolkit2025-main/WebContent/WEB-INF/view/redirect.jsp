		 ...
		 <div class="row">
	      <div class="col s12">
	        <div class="card-panel red">
	          ...
	          <div class="white-text center-align">Por favor acesse sua ideia novamenta na área de colaboração.</div>
	          <div class="right-align">
	          	<a class="white-text" href="/LIC" style="text-transform:uppercase;">
