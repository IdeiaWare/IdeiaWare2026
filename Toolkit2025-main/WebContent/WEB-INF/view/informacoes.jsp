		...
		<ul class="collapsible" data-collapsible="accordion">
			<li>	
				...
				<div class="collapsible-body">
					...
					<ul class="browser-default">
						...
						<li>O que ela fala e faz: Identifica como o cliente se comporta em público ou o que ele pode dizer quanto ao processo de consumo do produto. Objetivando encontrar o diferencial entre o que ele fala que está sentindo e o que ele realmente está pensando e sentindo.</li>
						<ul class="browser-default">
			...
			<li>
				...
				<div class="collapsible-body">
					...
					<ul class="browser-default">
						<li>O primeiro passo será a definição de quais tipos de pessoas o design será voltado, quais são a necessidades mais importantes a serem selecionadas e quais são os insights desenvolvidos que serão expressados. Neste caso os usuários/clientes podem ser definidos através do desenvolvimento de personas utilizando-se , por exemplo, do mapa de empatia, enquanto as necessidades são aquelas que foram adquiridas através das entrevistas, pesquisas e observações. Lembrando que os insights não podem ser as razões para a necessidade.
						...
						<li>O quarto passo contém os pontos importantes que o POV deve possuir, que é aquele que: Fornece um foco direto; Enquadra o problema como uma instrução de problema; Inspira a sua equipe; Orienta seus esforços de inovação; Informa critérios para avaliar ideias concorrentes; É sexy e capta a atenção das pessoas; É válido, perspicaz, acionável, único, direto, significativo e emocionante.</li>
					</ul>
				</div>
			</li>
		</ul>
