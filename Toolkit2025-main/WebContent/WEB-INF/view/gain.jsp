...
<t:header></t:header>
	...
	<nav class="crumb">
	    <div class="nav-wrapper">
	        ...
	        <span class="breadcrumb active">O que Ganha</span>
	    </div>
  	</nav>
	<div class="row">
		<div class="col s12 m6 vertical-divider">
			<h4>O que Ganha a cliente?</h4>
			<ul class="browser-default">
				<li>O que ela realmente quer ou precisa obter?</li>
				<li>Como mede o sucesso?</li>
				<li>Pense em algumas estratégias que pode utilizar para alcançar seus objetivos.</li>				
			</ul>
		</div>
		<div class="col s12 l6 attribute">
			<form:form action="quais-sao-os-ganhos/save-attribute" modelAttribute="attribute" method="POST" class="col s12">
				<div class="row">					
					<form:hidden class="attribute-id" path="id"/>
					<form:hidden path="personaId" value="${personaId}"/>
					<form:hidden path="attribute" value="gain"/>
